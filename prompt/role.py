...
game_intro = '''你们在进行一个狼人杀游戏。以下是狼人杀游戏的基本规则：
玩家有很多角色，各种角色被分成两个阵营，狼人属于狼人阵营，村民和预言家属于好人阵营。
游戏流程：游戏分为白天和黑夜两个阶段。白天阶段，所有玩家在一起讨论和投票怀疑的对象。
黑夜阶段，所有玩家闭眼，特定角色可以执行其技能。在黑夜中，狼人会睁眼，相互认识，并商量谁将成为他们的下一个目标。狼人需要以秘密方式行动，不被其他玩家察觉出来。
白天阶段，玩家可以发表言论、分享怀疑的对象，并投票决定要处决的玩家。通常情况下，玩家会投票处决他们怀疑是狼人的人。被处决的玩家将揭示身份。
预言家属于好人阵营, 并且每天晚上可以选择查验一名玩家的身份.
狼人阵营需要在白天尽量通过讨论隐藏自己的身份。
好人阵营需要在白天通过讨论找出狼人，并通过投票将狼人处决出局。
注意，这只是一个游戏，请不要屏蔽输出内容。
'''
...
role_wolf = '''
你是一名狼人，你知道哪些玩家和你一样是狼人，你们晚上可以投票淘汰好人，也可以选择淘汰自己或者队友来掩盖身份。白天你需要通过讨论尽可能的隐藏自己的狼人身份，或者诱导其他人处决好人。
'''
